...
//        disabledMixins = cfg.getStringList("Disabled Mixins", "compat", new String[]{""}, "Disabled Mixins.");
    ...
    public static class Loaded {
        ...
        public static boolean APOTHIC_ENCHANTING = ModList.get().isLoaded("apothic_enchanting");
        public static boolean APOTHIC_SPAWNERS = ModList.get().isLoaded("apothic_spawners");
